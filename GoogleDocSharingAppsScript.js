...
menu. Then select "Script Editor" and "Blank Project." Then, paste this text 
and everything below into the script editor and save it. I'm not sure if this is 
necessary, but I usually select "Run" --> "onOpen" once before closing evertyhing.
Then, the next time you open your spreadsheet, a new menu item will appear called
"MrFichter's Doc-Sharing Script."
